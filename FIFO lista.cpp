...
int main()
{
    ...
    do {
        ...
        case DODAJ_ELEMENT:
            ...
            if (push(stos, imie, nazwisko, rok_urodzenia) == 2) printf("Brak miejsca w kolejce!\n");
            else printf("Dodano element");
            break;

        case POBIERZ_ELEMENT:
            if (pop(stos) == 2) printf("Brak elementow w kolejce!\n");
        ...
        case SPRAWDZ_LICZBE_ELEMENTOW:
            printf("Liczba elementow w kolejce to: %d", count(stos));
            break;

        case USUN_STRUKTURE:
            delete_stack(stos);
            printf("Usunieto elementy kolejki");
            break;
